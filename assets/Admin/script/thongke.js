...
console.log(checktimeday("1/1/2024"));
...
function inputdate(){
  ...
  console.log(arrayCustomer(Customer));
  alert("jjj");
  console.log("hiiii");
...
taohangthongke(arrayCustomer(JSON.parse(localStorage.getItem("users"))),aggregateCartItems(JSON.parse(localStorage.getItem("users"))));